This repository is constructed by Zhiheng Zhang. It contains replication files for "Causal Inference Under Approximate Neighborhood Interference". The files were coded for Python 3 and require the following dependencies: numpy, scipy, networkx, and pandas.
