...
# 
data1 <- read.table("/home/ZhihengZhang/1031/syn/linear_parameter_X.txt", header = FALSE)
data2 <- read.table("/home/ZhihengZhang/1031/syn/linear_parameter_G.txt", header = FALSE)
data3 <- read.table("/home/ZhihengZhang/1031/syn/linear_parameter_noise.txt", header = FALSE)
# 
...
file_path <- "/home/ZhihengZhang/1031/syn/result_synthetic_nonlinear.txt"
...
###########################################################################################################################################################################################################
###########################################################################################################################################################################################################
file_path <- "nonlinear_parameter_X_final.txt"
write.table(X, file = file_path, col.names = FALSE)
file_path <- "nonlinear_parameter_G_final.txt"
write.table(G, file = file_path, col.names = FALSE)
file_path <- "nonlinear_parameter_noise_final.txt"
write.table(errors, file = file_path, col.names = FALSE)
